...
'OCICollection::append' => ['bool', 'value'=>''],
'OCICollection::assign' => ['bool', 'from'=>'OCICollection'],
'OCICollection::assignElem' => ['bool', 'index'=>'int', 'value'=>''],
'OCICollection::free' => ['bool'],
'OCICollection::getElem' => ['', 'index'=>'int'],
'OCICollection::max' => ['int'],
'OCICollection::size' => ['int'],
'OCICollection::trim' => ['bool', 'num'=>'int'],
'OCILob::append' => ['bool', 'lob_from'=>'OCILob'],
'OCILob::close' => ['bool'],
'OCILob::eof' => ['bool'],
'OCILob::erase' => ['int', 'offset='=>'int', 'length='=>'int'],
...
'OCILob::write' => ['int', 'data'=>'string', 'length='=>'int'],
